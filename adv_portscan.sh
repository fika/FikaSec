...
read fhost
echo ""
echo "${RED_TEXT}Enter the last host to scan (ex. 254)${END}"
read lhost
echo ""
echo "${RED_TEXT}Enter the first port to scan (ex. 1)${END}"
read fport
echo ""
echo "${RED_TEXT}Enter the last port to scan (ex. 1024)${END}"
read lport
echo ""
